        ...
        <div className="leaderboard-overlay">
            <div className="leaderboard-card">
                <div className="leaderboard-header">
                    ...
                    <h2 className="leaderboard-title">SALÓN DE LA FAMA</h2>
                    ...
                    {[1, 0, 2].map((orderIndex) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="rank-name">{player.username || `Jugador ${player.id.substring(0, 4)}`}</div>
                                <div className="rank-score">{player.total_wins} V</div>
                            </div>
                        );
                    })}
                </div>
                        ...
                        leaderboardData.slice(3).map((player, index) => (
                            ...
                            >
                                ...
                                <div className="player-info">
                                    <div className="player-name">{player.username || `Jugador ${player.id.substring(0, 5)}`}</div>
                                    <div className="player-stats">{player.total_games} partidas</div>
                                </div>
                                <div className="win-count" style={{ fontSize: '1rem' }}>{player.total_wins} V</div>
                            </div>
                        ))
                    )}
                </div>
